...
class Acciones:
    ...
    def crear(self, usuario):
        print(f"Ok {usuario[1][1]}!! Agenda una cita")

        titulo = input("Introduzca el titulo de la cita: ")
        nota = input("Introduzca una nota de la cita: ")
        
        paciente = input("Introduzca el nombre del paciente: ")

        sintomas = input("Introduzca los sintomas del paciente: ")

        print(f"\n{usuario[1][1]} Estos son los doctores:\n")
        ...
        while(True):
            doctor_id = input("Introduce el id de un doctor: ")
